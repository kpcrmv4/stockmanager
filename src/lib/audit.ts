...
export const AUDIT_ACTIONS = {
  ...
  COMMISSION_ENTRY_CANCELLED: 'COMMISSION_ENTRY_CANCELLED',
  COMMISSION_ENTRY_RESTORED: 'COMMISSION_ENTRY_RESTORED',
...
> = {
  ...
  COMMISSION_ENTRY_CANCELLED: { label: 'ยกเลิกรายการคอม', color: 'red', icon: 'x-circle' },
  COMMISSION_ENTRY_RESTORED: { label: 'กู้คืนรายการคอม', color: 'emerald', icon: 'rotate-ccw' },
